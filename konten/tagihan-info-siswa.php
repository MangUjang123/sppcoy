...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Riwayat Tagihan Dan Pembayaran</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <thead>
                            ...
                            while ($bayar_alokasi = mysqli_fetch_array($query)) {
                                echo "
                                    ...
                                    <td><a href='index.php?p=bayar-alokasi&id_bayar=$bayar_alokasi[id_bayar]' target='blank' title='Lihat Foto Bukti'>#$bayar_alokasi[id_bayar]</a> | <a href='file/bukti_bayar/$bayar_alokasi[bukti]' target='blank' title='Lihat Foto Bukti'><i class='fas fa-image'></i></a></td>
